          ...
          <div className=" grid grid-cols-6">
            ...
            <div className=" col-span-2 ">
              ...
              <div className="flex flex-col justify-start items-center bg-off_white border border-light_green rounded-md shadow mx-8 my-3 gap-y-3 mt-4 p-4">
                <span className='text-slate-600 text-start px-4 uppercase font-semibold text-xl mb-6 w-full'>total calculation</span>
                <div className="flex justify-between items-center w-full px-4">
                  <span className=' text-xl text-slate-600 font-semibold'>Total Product: </span>
                  <span className=' text-xl text-slate-700 font-semibold'>{cartProducts.length} </span>
                </div>
                <div className="flex justify-between items-center w-full px-4">
                  <span className=' text-xl text-slate-600 font-semibold'>Total Quantity: </span>
                  <span className='ml-2 text-lg text-slate-700 font-semibold'>{totalQuantity}</span>
                </div>
                <div className="flex justify-between items-center w-full px-4">
                  <span className=' text-xl text-slate-600 font-semibold'>Total Price: </span>
                  <span className='ml-2 text-lg text-slate-700 font-semibold'>{totalPrice}<span className=' ml-2 text-slate-500'>TK</span></span>
                </div>
                <div className=" w-[80%]">
